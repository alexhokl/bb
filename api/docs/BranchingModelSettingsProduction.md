...
**BranchDoesNotExist** | **bool** | Optional and only returned for a repository&#x27;s branching model. Indicates ifthe indicated branch exists on the repository (&#x60;false&#x60;)or not (&#x60;true&#x60;). This is useful for determining a fallback to the mainbranch when a repository is inheriting its project&#x27;s branching model. | [optional] [default to null]
