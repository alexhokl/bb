...
*/
func (a *CommitsApiService) BulkCreateOrUpdateAnnotations(ctx context.Context, workspace string, repoSlug string, commit string, reportId string, body []ReportAnnotation) ([]ReportAnnotation, *http.Response, error) {
	var (
...
@return ReportAnnotation
*/
func (a *CommitsApiService) CreateOrUpdateAnnotation(ctx context.Context, workspace string, repoSlug string, commit string, reportId string, annotationId string, body ReportAnnotation) (ReportAnnotation, *http.Response, error) {
	var (
...
@return Report
*/
func (a *CommitsApiService) CreateOrUpdateReport(ctx context.Context, workspace string, repoSlug string, commit string, reportId string, body Report) (Report, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *CommitsApiService) RepositoriesWorkspaceRepoSlugCommitCommitCommentsPost(ctx context.Context, commit string, repoSlug string, workspace string, body CommitComment) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
