...
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesExportPost(ctx context.Context, repoSlug string, workspace string, localVarOptionals *IssueTrackerApiRepositoriesWorkspaceRepoSlugIssuesExportPostOpts) (*http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(ExportOptions)
		if !localVarOptionalBodyok {
				return nil, reportError("body should be ExportOptions")
		}
...
@return IssueChange
*/
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesIssueIdChangesPost(ctx context.Context, issueId string, repoSlug string, workspace string, body IssueChange) (IssueChange, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return IssueComment
*/
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdPut(ctx context.Context, commentId int32, issueId string, repoSlug string, workspace string, body IssueComment) (IssueComment, *http.Response, error) {
	var (
...
*/
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsPost(ctx context.Context, issueId string, repoSlug string, workspace string, body IssueComment) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Issue
*/
func (a *IssueTrackerApiService) RepositoriesWorkspaceRepoSlugIssuesPost(ctx context.Context, repoSlug string, workspace string, body Issue) (Issue, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
