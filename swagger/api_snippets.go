 ...
 * @param encodedId The snippet id.
 * @param workspace This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: &#x60;{workspace UUID}&#x60;. 
 * @param body The contents to update the comment to.

@return SnippetComment
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommentsCommentIdPut(ctx context.Context, commentId int32, encodedId string, workspace string, body SnippetComment) (SnippetComment, *http.Response, error) {
	var (
...
@return SnippetComment
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdCommentsPost(ctx context.Context, encodedId string, workspace string, body SnippetComment) (SnippetComment, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdWatchDelete(ctx context.Context, encodedId string, workspace string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdWatchGet(ctx context.Context, encodedId string, workspace string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SnippetsApiService) SnippetsWorkspaceEncodedIdWatchPut(ctx context.Context, encodedId string, workspace string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Snippet
*/
func (a *SnippetsApiService) SnippetsWorkspacePost(ctx context.Context, workspace string, body Snippet) (Snippet, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
