...
**Pagelen** | **int32** | Current number of objects on the existing page. The default value is 500 with 5000 being the maximum allowed value. | [optional] [default to null]
...
**Values** | [**[]Diffstat**](diffstat.md) |  | [optional] [default to null]
